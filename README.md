...
**How to Reproduce the Data Analysis:** You will need to replace `[your-project-id]` placeholders with your own personal BigQuery project ID.
...
I created a custom Power BI JSON theme by scraping World of Warships' official branding colors to ensure an authentic and visually cohesive visualizations, which is included in the `04_visualizations/` directory.
